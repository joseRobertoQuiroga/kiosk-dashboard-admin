...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="flex h-screen bg-linear-to-br from-blue-50 to-green-50">
      ...
      {/* Sidebar */}
      <div
        className={`fixed lg:static inset-y-0 left-0 z-50 w-64 bg-white shadow-xl transform transition-transform duration-300 ease-in-out ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'
          }`}
      >
        ...
        <nav className="p-4">
          <button
            ...
            className={`w-full flex items-center space-x-3 px-4 py-3 rounded-lg mb-2 transition-all ${activeTab === 'overview'
          ...
          <button
            ...
            className={`w-full flex items-center space-x-3 px-4 py-3 rounded-lg mb-2 transition-all ${activeTab === 'kiosks'
          ...
          <button
            ...
            className={`w-full flex items-center space-x-3 px-4 py-3 rounded-lg mb-2 transition-all ${activeTab === 'products'
          ...
          <button
            ...
            className={`w-full flex items-center space-x-3 px-4 py-3 rounded-lg mb-2 transition-all ${activeTab === 'licenses'
              ? 'bg-linear-to-r from-purple-500 to-purple-600 text-white shadow-lg'
              : 'text-gray-600 hover:bg-gray-100'
              }`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center space-x-3 px-4 py-3 rounded-lg mb-2 transition-all ${activeTab === 'reports'
          ...
          <button
            ...
            className={`w-full flex items-center space-x-3 px-4 py-3 rounded-lg mb-2 transition-all ${activeTab === 'video'
              ? 'bg-linear-to-r from-purple-500 to-purple-600 text-white shadow-lg'
              : 'text-gray-600 hover:bg-gray-100'
              }`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center space-x-3 px-4 py-3 rounded-lg transition-all ${activeTab === 'config'
      ...
      <div className="flex-1 overflow-auto">
        <div className="p-4 lg:p-8">
          ...
          <button
            ...
            className="lg:hidden fixed top-4 left-4 z-30 p-2 bg-white rounded-lg shadow-lg text-gray-700 hover:bg-gray-100"
          >
            <Menu size={24} />
          </button>

          {/* Header */}
          <div className="mb-6 lg:mb-8 flex flex-col lg:flex-row lg:justify-between lg:items-center gap-4 pt-16 lg:pt-0">
            <div>
          ...
          {activeTab === 'overview' && dashboardData && (
            <>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 mb-6 lg:mb-8">
                <div className="bg-white rounded-xl p-4 lg:p-6 shadow-lg border-l-4 border-blue-500">
                ...
                <div className="bg-white rounded-xl p-4 lg:p-6 shadow-lg border-l-4 border-green-500">
                  <div className="flex justify-between items-start">
                    <div>
                ...
                <div className="bg-white rounded-xl p-4 lg:p-6 shadow-lg border-l-4 border-red-500">
                  <div className="flex justify-between items-start">
                    <div>
                ...
                <div className="bg-white rounded-xl p-4 lg:p-6 shadow-lg border-l-4 border-purple-500">
                  <div className="flex justify-between items-start">
                    <div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6 mb-6 lg:mb-8">
                ...
                {dashboardData?.consultasPorKiosco && dashboardData.consultasPorKiosco.length > 0 && (
                  <div className="bg-white rounded-xl p-4 lg:p-6 shadow-lg mt-4 lg:mt-6">
                    <h3 className="text-lg font-bold text-gray-800 mb-4">
                            ...
                            return (
                              ...
                              >
                                ...
                                <td className="py-3 px-4 text-right">
                                  <span
                                    className={`font-semibold ${parseFloat(tasaExito) >= 90
                                      ? 'text-green-600'
            ...
            <div className="space-y-6">
              ...
              {tablaKioscos && (
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 lg:gap-6">
                  <div className="bg-linear-to-br from-blue-500 to-blue-600 rounded-xl p-4 lg:p-6 shadow-lg text-white">
                    <p className="text-sm opacity-90">Total de Kioscos</p>
                    <p className="text-4xl font-bold mt-2">{tablaKioscos.total_kioscos}</p>
                  </div>
                  <div className="bg-linear-to-br from-green-500 to-green-600 rounded-xl p-4 lg:p-6 shadow-lg text-white">
                    <p className="text-sm opacity-90">Kioscos Activos</p>
                    <p className="text-4xl font-bold mt-2">{tablaKioscos.kioscos_activos}</p>
                  </div>
                  <div className="bg-linear-to-br from-purple-500 to-purple-600 rounded-xl p-4 lg:p-6 shadow-lg text-white">
              ...
              <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                <div className="p-4 lg:p-6 bg-linear-to-r from-blue-50 to-green-50 border-b">
              ...
              {selectedKiosk && rendimientoKioscos && (
                <div className="bg-white rounded-xl p-4 lg:p-6 shadow-lg border-2 border-blue-200">
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="space-y-3">
                            ...
                            <div className="flex justify-between">
                              ...
                              <span
                                className={`font-medium ${rendimiento.estado === 'alto_rendimiento'
                                  ? 'text-green-600'
          ...
          {showCreateModal && (
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
              <div className="bg-white rounded-xl p-4 lg:p-8 max-w-md w-full mx-4 shadow-2xl">
              ...
              <div className="bg-white rounded-xl p-4 shadow-lg">
                <div className="flex flex-col md:flex-row items-stretch md:items-center gap-4">
                  <button
                    ...
                    className={`flex-1 py-3 px-4 rounded-lg font-medium transition-all ${activeReport === 'productos'
                      ? 'bg-linear-to-r from-blue-500 to-blue-600 text-white shadow-lg'
                  ...
                  <button
                    ...
                    className={`flex-1 py-3 px-4 rounded-lg font-medium transition-all ${activeReport === 'kioscos'
                      ? 'bg-linear-to-r from-green-500 to-green-600 text-white shadow-lg'
                      : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`flex-1 py-3 px-4 rounded-lg font-medium transition-all ${activeReport === 'mixto'
                      ? 'bg-linear-to-r from-purple-500 to-purple-600 text-white shadow-lg'
                      : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
                      }`}
                  >
